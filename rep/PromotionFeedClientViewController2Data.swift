...
import Lottie
class PromotionFeedClientViewController2Data: ObjectFeedClientViewController  , UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,NVActivityIndicatorViewable{
    ...
    override func viewDidLoad() {
        ...
        //getDataByCategory(category: "promotions", wallet: (client?.address)!, token: token , client : client! , cat : subMenu)
        for feed in AppDelegate.tabFeedCategoryPromotion{
            if (self.subMenu == "All"){
...
extension PromotionFeedClientViewController2Data {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (collectionViewData == collectionView){
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cellPromotionFeedClient", for: indexPath) as! cellPromotionFeedClient
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        let cell = collectionView.cellForItem(at: indexPath as IndexPath) as? cellPromotionFeedClient
