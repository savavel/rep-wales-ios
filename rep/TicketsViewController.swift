 ...
 class TicketsViewController: SUPERCLASSViewController  , UICollectionViewDataSource, UICollectionViewDelegate, NVActivityIndicatorViewable {
    ...
    override func viewDidLoad() {
        ...
        for i in clients {
            getDataByCategory(category: "ticket", wallet: i.address, token: token , client : i, compteur : -1)
        }
    ...
    func refresh(sender:AnyObject)
    {
        ...
        for i in clients {
            ...
            getDataByCategory(category: "ticket", wallet: i.address, token: token , client : i , compteur : compteur)
            compteur = compteur + 1
        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withReuseIdentifier: "LiveFeedTicketCollectionViewCell", for: indexPath) as! LiveFeedTicketCollectionViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "Detail" {
            ...
            let cell = tableView.cellForItem(at: indexPath as IndexPath) as? LiveFeedTicketCollectionViewCell
