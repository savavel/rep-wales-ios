...
class PromotionViewController: SUPERCLASSViewController  , UICollectionViewDataSource, UICollectionViewDelegate , NVActivityIndicatorViewable {
    ...
    override func viewDidLoad() {
        ...
        for i in clients {
            ...
            getDataByCategory(category: "promotions", wallet: i.address, token: token , client : i , compteur : -1)
        }
    ...
    func refresh(sender:AnyObject)
    {
        ...
        for i in clients {
            print("WALLET , +  \(i.address) ")
            getDataByCategory(category: "promotions", wallet: i.address, token: token , client : i , compteur : compteur)
            compteur = compteur + 1
        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withReuseIdentifier: "LiveFeedPromotionCollectionViewCell", for: indexPath) as! LiveFeedPromotionCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        let cell = collectionView.cellForItem(at: indexPath) as? LiveFeedPromotionCollectionViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "Detail" {
            ...
            let cell = tableView.cellForItem(at: indexPath as IndexPath) as? LiveFeedPromotionCollectionViewCell
        ...
        self.tabFeedNonSorted.removeAll()
         ...
         AFWrapper.requestPOSTURL(Urls.CATAGORY_LIST, params: params, headers: headers,
                                 success: {
                                    ...
                                    if (compteur == self.clients.count - 1){
                                        self.refreshControl.endRefreshing()
                                        self.tableView.reloadData()
