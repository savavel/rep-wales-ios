//
//  FoodFeedClientViewController2.swift
//  rep
//
...
class  FoodFeedClientViewController2: ObjectFeedClientViewController  , UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    var preIndex = 0
    var withClick = false
    static var sharedCountSubMenuFoodFeed : Int = 0
    static var sharedTabSubCategoryFoodFeed : [String] = []
    ...
    var tutorialPageViewController: FoodPageViewController? {
        didSet {
            tutorialPageViewController?.tutorialDelegate = self
        }
    }
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let tutorialPageViewController = segue.destination as? FoodPageViewController {
...
extension FoodFeedClientViewController2 {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (self.collectionView == collectionView){
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "myCellFoodsPager", for: indexPath) as! myCellFoodsPager
    ...
    func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
        ...
        if (self.collectionView == collectionView){
            ...
            if (collectionView.cellForItem(at : indexPath) != nil){
                let cell = collectionView.cellForItem(at : indexPath) as! myCellFoodsPager
...
extension FoodFeedClientViewController2: FoodPageViewControllerDelegate {
        ...
        AFWrapper.requestPOSTURL(Urls.CATAGORY_LIST, params: params, headers: headers,
                                 success: {
                                    ...
                                    for k in self.tab{
                                        ...
                                        self.tutorialPageViewController?.orderedViewControllers.append((self.tutorialPageViewController?.newColoredViewController("FoodFeedClientViewController2Data" , subMenu : k ))!)
                                    }
    ...
    func setSubCategory(){
        ...
        print(" SUB CATEGORY FOOD : = \(self.tab)")
        self.tabMenuDrink = self.tab
    FoodFeedClientViewController2.sharedCountSubMenuFoodFeed = self.tab.count
    FoodFeedClientViewController2.sharedTabSubCategoryFoodFeed = self.tab
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if (self.tutorialPageViewController?.i == 0){
            ...
            //getDataByCategory(category: "food", wallet: (client?.address)!, token: token , client : client!)
           
            self.tabFeed = AppDelegate.tabFeedCategoryFood
            self.tabFeedSearch = AppDelegate.tabFeedSearchCategoryFood
            self.setSubCategory()
            self.collectionView.reloadData()
            //self.collectionViewData.reloadData()
    ...
    func tutorialPageViewController(_ tutorialPageViewController: FoodPageViewController,
        ...
        if (currentIndex != preIndex){
            ...
            if (tabFeedSearch.count != 0){
                ...
                if ( self.collectionView.cellForItem(at : IndexPath(row: index, section: 0) )  != nil){
                    let cellCurrentIndex = self.collectionView.cellForItem(at : IndexPath(row: index, section: 0) ) as! myCellFoodsPager
                ...
                if (self.collectionView.cellForItem(at : IndexPath(row: preIndex, section: 0) ) != nil ){
                    let cellPreIndex = self.collectionView.cellForItem(at : IndexPath(row: preIndex, section: 0) ) as! myCellFoodsPager
