//
//  FoodFeedClientViewController2Data.swift
//  rep
//
...
import Lottie
class FoodFeedClientViewController2Data: ObjectFeedClientViewController  , UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,NVActivityIndicatorViewable{
    ...
    override func viewDidLoad() {
        ...
        //getDataByCategory(category: "food", wallet: (client?.address)!, token: token , client : client! , cat : subMenu)
        for feed in AppDelegate.tabFeedCategoryFood{
            if (self.subMenu == "All"){
...
extension FoodFeedClientViewController2Data {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (collectionViewData == collectionView){
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cellFoodFeedClient", for: indexPath) as! cellFoodFeedClient
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        let cell = collectionView.cellForItem(at: indexPath as IndexPath) as? cellFoodFeedClient
