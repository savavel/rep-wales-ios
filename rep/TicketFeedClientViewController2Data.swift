//
//  TicketFeedClientViewController2Data.swift
//  rep
//
...
import Lottie
class TicketFeedClientViewController2Data: ObjectFeedClientViewController  , UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,NVActivityIndicatorViewable{
    ...
    override func viewDidLoad() {
        ...
        print("**************** FROM Food CLIENT Client :xwxcwxcwxc wxc wxc wxc  \(subMenu)")
        
        
        //getDataByCategory(category: "ticket", wallet: (client?.address)!, token: token , client : client! , cat : subMenu)
        for feed in AppDelegate.tabFeedCategoryTicket{
            if (self.subMenu == "All"){
        ...
        print("**************** END Food CLIENT Client : \(client?.name)")
...
extension TicketFeedClientViewController2Data {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (collectionViewData == collectionView){
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cellTicketFeedClient", for: indexPath) as! cellTicketFeedClient
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        let cell = collectionView.cellForItem(at: indexPath as IndexPath) as? cellTicketFeedClient
