...
class DrinkFeedClientViewController2: ObjectFeedClientViewController  , UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    var firstView : Int = 0
    var withClick = false
    static var sharedCountSubMenuDrinkFeed : Int = 0
    static var sharedTabSubCategoryDrinkFeed : [String] = []
    ...
    var tutorialPageViewController: DrinkPageViewController? {
        didSet {
            tutorialPageViewController?.tutorialDelegate = self
        }
    }
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let tutorialPageViewController = segue.destination as? DrinkPageViewController {
...
extension DrinkFeedClientViewController2 {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (self.collectionView == collectionView){
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "myCellDrinkPager", for: indexPath) as! myCellDrinkPager
   ...
   func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
        ...
        if (self.collectionView == collectionView){
           ...
           // if (collectionView.cellForItem(at : indexPath) != nil){
                let cell = collectionView.cellForItem(at : indexPath) as! myCellDrinkPager
...
extension DrinkFeedClientViewController2: DrinkPageViewControllerDelegate {
        ...
        AFWrapper.requestPOSTURL(Urls.CATAGORY_LIST, params: params, headers: headers,
                                 success: {
                                    ...
                                    for k in self.tab{
                                       ...
                                       self.tutorialPageViewController?.orderedViewControllers.append((self.tutorialPageViewController?.newColoredViewController("DrinkFeedClientViewController2Data" , subMenu : k ))!)
                                    }
    ...
    func setSubCategory(){
        ...
        DrinkFeedClientViewController2.sharedCountSubMenuDrinkFeed = self.tab.count
        DrinkFeedClientViewController2.sharedTabSubCategoryDrinkFeed = self.tab
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if (self.tutorialPageViewController?.i == 0){
            ...
            //getDataByCategory(category: "drinks", wallet: (client?.address)!, token: token , client : client!)
            
            /******************************** Category **************************/
            self.tabFeed = AppDelegate.tabFeedCategoryDrink
            self.tabFeedSearch = AppDelegate.tabFeedSearchCategoryDrink
            self.setSubCategory()
            self.collectionView.reloadData()
            //self.collectionViewData.reloadData()
    ...
    func tutorialPageViewController(_ tutorialPageViewController: DrinkPageViewController,
    ...
    func tutorialPageViewController(_ tutorialPageViewController: DrinkPageViewController,
        ...
        firstView = firstView + 1
         ...
         if (currentIndex != preIndex){
            ...
            if (tabFeedSearch.count != 0){
                ...
                if (tab.count == index+1){
                    ...
                    DispatchQueue.main.asyncAfter(deadline: when) {
                        ...
                        let cellCurrentIndex = self.collectionView.cellForItem(at : IndexPath(row: index, section: 0) ) as! myCellDrinkPager
                    ...
                    if (self.collectionView.cellForItem(at : IndexPath(row: tab.count-2, section: 0) ) != nil ){
                        let cellPreIndex = self.collectionView.cellForItem(at : IndexPath(row: preIndex, section: 0) ) as! myCellDrinkPager
            ...
            print("***********currentIndex  \(currentIndex)*******************preIndex \(preIndex)*******************")
        }
        withClick = false
